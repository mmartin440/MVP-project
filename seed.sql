...
INSERT INTO cars (model, make, year, miles, description, price, owner_id) VALUES ('ranger', 'ford', 2010, '1700', 'CAR PREETY GOOD',1000, 1);
INSERT INTO cars (model, make, year, miles, description, price, owner_id) VALUES ('sad car', 'ford', 1799, '600', 'PLEASE BUY CAR NOW',15, 1);
INSERT INTO cars (model, make, year, miles, description, price, owner_id) VALUES ('XXXL', 'tesla', 3300, '0', 'ITS A CAR', 80, 1);
INSERT INTO cars (model, make, year, miles, description, price, owner_id) VALUES ('FF26', 'Jeep', 2010, '1700', 'good condtion',1000, 1);
